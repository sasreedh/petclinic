node 
  {
          ...
          stage('Sonar Analysis') 
	{
		withSonarQubeEnv('sonar') 
		{
		  ...
		  sh "curl -u $USERNAME:$PASSWORD -T /var/lib/jenkins/workspace/Petclinic/target/petclinic.war 'http://localhost:8081/manager/text/deploy?path=/Petclinic-Dev&update=true'"
		  }
